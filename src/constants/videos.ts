...
export const videos: Video[] = [
  ...
  },
  {
    ...
    location: 'CHICAGO',
    category: 'music-video',
    videoUrl: getVideoUrl('MgnaCRRRTA.mp4'),
    thumbnail: getVideoUrl('MgnaCRRRTA.mp4'),
    featured: true,
  },
  {
    id: 'shoot-reel-1776802607072991',
  ...
  {
    id: 'shoot-reel-1776903207924937',
